...
| Version | Changes |
| :--- | :--- |
| **Version 0.0.6** | * Add ability for lead participant or GM to roll the complementary skill from the chat card.<br>* Close Skill Boost or Group Task window when the results are sent to chat. |
